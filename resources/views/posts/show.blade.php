                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <div
                                                class="w-full rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                {{ $post->hours }}時間{{ $post->minutes }}分</div>
                                        </div>
                                    </div>
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                    ...
                                    <form method="get" action="{{ route('posts.edit', ['post' => $post->id]) }}">
                                        <div class="p-2 w-full">
                                            <button
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">修正する</button>
                                        </div>
                                    </form>
                                    {{-- 削除ボタン --}}
