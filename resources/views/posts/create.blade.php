                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="grid grid-cols-[1fr_auto] items-center gap-2">
                                <select id="hours" name="hours" 
                                    ...
                                    <option value="{{$hours}}" {{ old('hours') == $hours ? 'selected' : '' }}>{{$hours}}</option>
                                    @endfor
                                </select>
                                ...
                                <select id="minutes" name="minutes" 
                                    ...
                                    <option value="{{$minutes}}" {{ old('minutes') == $minutes ? 'selected' : '' }}>{{$minutes}}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="p-2 w-full">
                            ...
                            <select name="status" id="status" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                ...
                                <option value="1" {{ old('status') == 1 ? 'selected' : '' }}>仕事</option>
                        ...
                        <div class="p-2 w-full">
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">記録する</button>
                        </div>
                        </div>
                    </div>
                    </div>
